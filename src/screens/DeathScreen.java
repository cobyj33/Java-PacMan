...
public class DeathScreen extends JPanel {
	...
	DeathScreen(ScreenManager manager, PacMan game) {
		...
		textPane.setText("PELLETS EATEN: " + game.getPlayer().pelletsEaten);
		constraints.gridy = 1;
		...
		addAncestorListener(new utilities.AncestorAdapter() {
			...
			public void ancestorAdded(AncestorEvent event) {
				textPane.setText("PELLETS EATEN: " + game.getPlayer().pelletsEaten + "\n" + 
						"LEVELS CLEARED: " + (game.level - 1) + "\n" +
						"GHOSTS EATEN: " + game.getPlayer().ghostsEaten + "\n" +
						"TOTAL SCORE: " + game.getPlayer().getScore());
			}
		});
	}
